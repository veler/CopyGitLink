...
namespace CopyGitLink.Tests.Core.GitOnlineServices
{
    ...
    public class AzureDevOpsTests
    {
        ...
        public async Task VisualStudioComAsync()
        {
            ...
            Assert.IsTrue(await azureDevOps.TryDetectRepositoryInformationAsync(string.Empty, "https://contoso.visualstudio.com/DefaultCollection/Contoso/_git/_optimized/MyRepository", CancellationToken.None, out repositoryInfo));
            Assert.AreEqual("contoso", repositoryInfo.Properties["Organization"]);
            Assert.AreEqual("Contoso", repositoryInfo.Properties["Project"]);
            Assert.AreEqual("MyRepository", repositoryInfo.Properties["Repository"]);
            Assert.AreEqual("https://contoso.visualstudio.com/", repositoryInfo.Properties["OrganizationUrl"]);
            ...
            Assert.IsTrue(await azureDevOps.TryDetectRepositoryInformationAsync(string.Empty, "https://contoso.visualstudio.com/DefaultCollection/Contoso/_git/_full/MyRepository", CancellationToken.None, out repositoryInfo));
            Assert.AreEqual("contoso", repositoryInfo.Properties["Organization"]);
            Assert.AreEqual("Contoso", repositoryInfo.Properties["Project"]);
            Assert.AreEqual("MyRepository", repositoryInfo.Properties["Repository"]);
            Assert.AreEqual("https://contoso.visualstudio.com/", repositoryInfo.Properties["OrganizationUrl"]);
